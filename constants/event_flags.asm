...
; Johto story events
	...
	const EVENT_GOT_TWISTEDSPOON_FROM_TUSCANY
...
; Crystal-exclusive events in Johto
	...
	const EVENT_TALKED_TO_FLORIA_AT_FLOWER_SHOP ; unused in Sour Crystal. Event was redone to match HGSS.
...
; Kanto hidden items
	...
	const EVENT_ROUTE_39_OPAL_SHARD
	const EVENT_ROUTE_45_OPAL_SHARD
	const EVENT_ROUTE_11_OPAL_SHARD
	const EVENT_ROUTE_4_OPAL_SHARD
...
; Sour Crystal events
	...
	const EVENT_ROUTE_47_OPAL_SHARD
	...
	const EVENT_BEAT_PICNICKER_EAMER
	...
	const EVENT_ROUTE_13_BERRY
	const EVENT_SILVER_CAVE_OUTSIDE_BERRY
	const EVENT_SAFARI_ZONE_KANTO_ENTRANCE_OFFICER_SAFARI_GAME_ACTIVE
	const EVENT_SAFARI_ZONE_KANTO_ENTRANCE_OFFICER_SAFARI_GAME_NOT_ACTIVE
...
; Sour Crystal events
	...
	const EVENT_RUINS_OF_ALPH_RESEARCH_CENTER_TUTOR_CAUGHT_ALL_UNOWN
	const EVENT_RUINS_OF_ALPH_RESEARCH_CENTER_TUTOR_CAUGHT_21_UNOWN
...
; Crystal-exclusive trainer flags
	...
	const EVENT_BEAT_TWINS_DAYANDDANI
	const EVENT_BEAT_CAMPER_VIKTOR
...
; New to Crystal
	...
	const EVENT_BEAT_CHAMPION_LANCE_REMATCH
	const EVENT_GOT_SILVER_TROPHY
	const EVENT_GOT_GOLD_TROPHY
	const EVENT_NEW_BARK_TOWN_PACKAGE
	const EVENT_SAFARI_ZONE_KANTO_AREA_1_NUGGET
	const EVENT_SAFARI_ZONE_KANTO_AREA_2_CARBOS
	const EVENT_SAFARI_ZONE_KANTO_AREA_2_MAX_POTION
	const EVENT_SAFARI_ZONE_KANTO_AREA_2_FULL_RESTORE
	const EVENT_SAFARI_ZONE_KANTO_AREA_2_LUCKY_EGG
	const EVENT_SAFARI_ZONE_KANTO_AREA_3_LUCKY_PUNCH
	const EVENT_SAFARI_ZONE_KANTO_AREA_3_PROTEIN
	const EVENT_SAFARI_ZONE_KANTO_AREA_3_KINGS_ROCK
	const EVENT_SAFARI_ZONE_KANTO_AREA_4_GOLD_LEAF
	const EVENT_SAFARI_ZONE_KANTO_AREA_4_MAX_ETHER
	const EVENT_SAFARI_ZONE_KANTO_AREA_4_MAX_POTION
	const EVENT_SAFARI_ZONE_KANTO_AREA_4_MAX_REVIVE
	const EVENT_SAFARI_ZONE_KANTO_AREA_4_HIDDEN_REVIVE
