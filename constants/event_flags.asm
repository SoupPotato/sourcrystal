...
; ???
	...
	const EVENT_YELLOW_FOREST_HIDDEN_GOLD_LEAF
	const EVENT_YELLOW_FOREST_HIDDEN_SILVER_LEAF
	...
	const EVENT_BEAT_LASS_ISABEL
	const EVENT_BEAT_TEACHER_KATHRYN
	const EVENT_BEAT_COOLTRAINER_SOPHIE
	...
	const EVENT_ROUTE29_BERRY
	const EVENT_ROUTE29_APRICORN
	const EVENT_ROUTE30_BERRY
	const EVENT_ROUTE30_BERRY2
	const EVENT_ROUTE30_APRICORN
	const EVENT_ROUTE30_APRICORN2
	const EVENT_ROUTE31_BERRY
	const EVENT_ROUTE31_APRICORN
	const EVENT_VIOLET_BERRY
	const EVENT_VIOLET_APRICORN
	const EVENT_ROUTE33_BERRY
	const EVENT_ROUTE33_APRICORN
	const EVENT_ROUTE33_APRICORN2
	const EVENT_AZALEA_APRICORN
	const EVENT_ROUTE35_BERRY
	const EVENT_ROUTE35_APRICORN
	const EVENT_ROUTE36_BERRY
	const EVENT_ROUTE36_APRICORN
	const EVENT_ROUTE37_APRICORN
	const EVENT_ROUTE37_APRICORN2
	const EVENT_ROUTE37_APRICORN3
	const EVENT_ROUTE38_BERRY
	const EVENT_ROUTE38_APRICORN
	const EVENT_ROUTE39_BERRY
	const EVENT_ROUTE39_APRICORN
	const EVENT_ROUTE42_APRICORN
	const EVENT_ROUTE42_APRICORN2
	const EVENT_ROUTE42_APRICORN3
	const EVENT_ROUTE43_BERRY
	const EVENT_ROUTE43_APRICORN
	const EVENT_ROUTE44_BERRY
	const EVENT_ROUTE44_APRICORN
	const EVENT_ROUTE45_BERRY
	const EVENT_ROUTE45_APRICORN
	const EVENT_ROUTE46_BERRY
	const EVENT_ROUTE46_BERRY2
	const EVENT_ROUTE46_APRICORN
	const EVENT_ROUTE46_APRICORN2
	const EVENT_ROUTE26_BERRY
	const EVENT_ROUTE26_APRICORN
	const EVENT_ROUTE1_BERRY
	const EVENT_ROUTE1_APRICORN
	const EVENT_VIRIDIAN_FOREST_BERRY
	const EVENT_VIRIDIAN_FOREST_APRICORN
	const EVENT_PEWTER_BERRY
	const EVENT_PEWTER_BERRY2
	const EVENT_PEWTER_APRICORN
	const EVENT_PEWTER_APRICORN2
	const EVENT_ROUTE8_BERRY
	const EVENT_ROUTE8_APRICORN
	const EVENT_ROUTE11_BERRY
	const EVENT_ROUTE11_APRICORN
...
; Johto itemballs
	...
	const EVENT_DARK_CAVE_BLACKTHORN_ENTRANCE_COVENANT_ORB
...
; Kanto people
	...
	const EVENT_ROUTE11_SNORLAX ; 770
