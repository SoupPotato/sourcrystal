...
; BATTLE_ANIM_OBJ_FLAMETHROWER
	battleanimobj RELATIVE_X, $90, BATTLE_ANIM_FRAMESET_FLAMETHROWER, BATTLE_ANIM_FUNC_FLAMETHROWER, PAL_BATTLE_OB_RED, BATTLE_ANIM_GFX_FIRE
...
; BATTLE_ANIM_OBJ_CLAMP
	battleanimobj RELATIVE_X | X_FLIP, $92, BATTLE_ANIM_FRAMESET_CLAMP_1, BATTLE_ANIM_FUNC_RADIAL_MOVE_OUT_SLOW, PAL_BATTLE_OB_GRAY, BATTLE_ANIM_GFX_REFLECT
; BATTLE_ANIM_OBJ_CLAMP_2
	battleanimobj RELATIVE_X | X_FLIP, $92, BATTLE_ANIM_FRAMESET_CLAMP_2, BATTLE_ANIM_FUNC_RADIAL_MOVE_OUT_SLOW, PAL_BATTLE_OB_GRAY, BATTLE_ANIM_GFX_REFLECT
