...
; entries correspond to ENGINE_* constants
	...
	engine_flag wDailyFlags1, DAILYFLAGS_ILEX_FOREST_TINYMUSHROOM_1
	engine_flag wDailyFlags1, DAILYFLAGS_ILEX_FOREST_TINYMUSHROOM_2
	engine_flag wDailyFlags1, DAILYFLAGS_ILEX_FOREST_TINYMUSHROOM_3
