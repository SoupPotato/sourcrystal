...
MapGroup_Dungeons:
	...
	map CeruleanCave1F, TILESET_DARK_CAVE, CAVE, CERULEAN_CAVE, MUSIC_VICTORY_ROAD, TRUE, PALETTE_DARK, FISHGROUP_LAKE
	map CeruleanCave2F, TILESET_DARK_CAVE, CAVE, CERULEAN_CAVE, MUSIC_VICTORY_ROAD, TRUE, PALETTE_DARK, FISHGROUP_LAKE
	map CeruleanCaveB1F, TILESET_DARK_CAVE, CAVE, CERULEAN_CAVE, MUSIC_VICTORY_ROAD, TRUE, PALETTE_DARK, FISHGROUP_LAKE
