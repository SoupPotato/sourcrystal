...
;\3: environment: TOWN, ROUTE, INDOOR, CAVE, SAFARI_ZONE, GATE, or DUNGEON
...
MapGroup_Dungeons:
	...
	map SafariZoneKantoEntrance, TILESET_GATE, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_CERULEAN_CITY_HGSS, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map CliffCave, TILESET_CAVE, CAVE, LANDMARK_CLIFF_CAVE, MUSIC_ROUTE_47_HGSS, TRUE, PALETTE_NITE, FISHGROUP_LAKE
...
MapGroup_Cinnabar:
	...
	map PokemonMansion1F, TILESET_FACILITY, CAVE, LANDMARK_POKEMON_MANSION, MUSIC_CINNABAR_MANSION, FALSE, PALETTE_NITE, FISHGROUP_OCEAN
	map PokemonMansionB1F, TILESET_FACILITY, CAVE, LANDMARK_POKEMON_MANSION, MUSIC_CINNABAR_MANSION, FALSE, PALETTE_NITE, FISHGROUP_OCEAN
	assert_table_length NUM_CINNABAR_MAPS

MapGroup_Cerulean:
	table_width MAP_LENGTH
	map CeruleanGymBadgeSpeechHouse, TILESET_HOUSE, INDOOR, LANDMARK_CERULEAN_CITY, MUSIC_CERULEAN_CITY_HGSS, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeruleanPoliceStation, TILESET_HOUSE, INDOOR, LANDMARK_CERULEAN_CITY, MUSIC_CERULEAN_CITY_HGSS, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeruleanTradeSpeechHouse, TILESET_HOUSE, INDOOR, LANDMARK_CERULEAN_CITY, MUSIC_CERULEAN_CITY_HGSS, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map CeruleanMart, TILESET_MART, INDOOR, LANDMARK_CERULEAN_CITY, MUSIC_CERULEAN_CITY_HGSS, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map Route24, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_24, MUSIC_NUGGET_BRIDGE_HGSS, FALSE, PALETTE_AUTO, FISHGROUP_LAKE
	map Route25, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_25, MUSIC_NUGGET_BRIDGE_HGSS, FALSE, PALETTE_AUTO, FISHGROUP_LAKE
	map CeruleanCity, TILESET_KANTO, TOWN, LANDMARK_CERULEAN_CITY, MUSIC_CERULEAN_CITY_HGSS, FALSE, PALETTE_AUTO, FISHGROUP_NONE
...
MapGroup_Fuchsia:
	...
	map FuchsiaCity, TILESET_KANTO, TOWN, LANDMARK_FUCHSIA_CITY, MUSIC_CERULEAN_CITY_HGSS, FALSE, PALETTE_AUTO, FISHGROUP_GYARADOS
	map FuchsiaMart, TILESET_MART, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_CERULEAN_CITY_HGSS, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SafariZoneMainOffice, TILESET_FACILITY, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_CERULEAN_CITY_HGSS, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map FuchsiaGym, TILESET_LAB, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_GYM, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map BillsOlderSistersHouse, TILESET_HOUSE, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_CERULEAN_CITY_HGSS, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map FuchsiaPokecenter2FBeta, TILESET_POKECENTER, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_CERULEAN_CITY_HGSS, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SafariZoneWardensHome, TILESET_HOUSE, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_CERULEAN_CITY_HGSS, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Viridian:
	...
	map ViridianForest, TILESET_FOREST, ROUTE, LANDMARK_VIRIDIAN_FOREST, MUSIC_ROUTE_2, FALSE, PALETTE_NITE, FISHGROUP_SHORE
...
MapGroup_SafariZoneGate:
	...
	map SafariZoneEntrance, TILESET_GATE, INDOOR, LANDMARK_SAFARI_ZONE_GATE, MUSIC_SAFARI_ZONE_GATE_HGSS, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SafariZoneGate, TILESET_JOHTO, TOWN, LANDMARK_SAFARI_ZONE_GATE, MUSIC_SAFARI_ZONE_GATE_HGSS, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	...
	map SafariZoneArea1, TILESET_PARK, SAFARI_ZONE_ENV, LANDMARK_SAFARI_ZONE, MUSIC_EVOLUTION, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map SafariZoneArea2, TILESET_PARK, SAFARI_ZONE_ENV, LANDMARK_SAFARI_ZONE, MUSIC_EVOLUTION, FALSE, PALETTE_AUTO, FISHGROUP_LAKE
	map SafariZoneArea4, TILESET_FOREST, SAFARI_ZONE_ENV, LANDMARK_SAFARI_ZONE, MUSIC_EVOLUTION, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_SafariZone:
	table_width MAP_LENGTH
	map SafariZoneArea3, TILESET_PARK, SAFARI_ZONE_ENV, LANDMARK_SAFARI_ZONE, MUSIC_EVOLUTION, FALSE, PALETTE_AUTO, FISHGROUP_POND
	...
	map SafariZoneKantoArea1, TILESET_KANTO, SAFARI_ZONE_ENV, LANDMARK_SAFARI_ZONE_KANTO, MUSIC_EVOLUTION, FALSE, PALETTE_AUTO, FISHGROUP_DRATINI
	map SafariZoneKantoArea2, TILESET_KANTO, SAFARI_ZONE_ENV, LANDMARK_SAFARI_ZONE_KANTO, MUSIC_EVOLUTION, FALSE, PALETTE_AUTO, FISHGROUP_DRATINI
	map SafariZoneKantoArea3, TILESET_KANTO, SAFARI_ZONE_ENV, LANDMARK_SAFARI_ZONE_KANTO, MUSIC_EVOLUTION, FALSE, PALETTE_AUTO, FISHGROUP_DRATINI
	map SafariZoneKantoArea4, TILESET_KANTO, SAFARI_ZONE_ENV, LANDMARK_SAFARI_ZONE_KANTO, MUSIC_EVOLUTION, FALSE, PALETTE_AUTO, FISHGROUP_DRATINI
	map SafariKantoRestHouseArea1, TILESET_FACILITY, INDOOR, LANDMARK_SAFARI_ZONE_KANTO, MUSIC_EVOLUTION, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SafariKantoRestHouseArea2, TILESET_FACILITY, INDOOR, LANDMARK_SAFARI_ZONE_KANTO, MUSIC_EVOLUTION, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SafariKantoRestHouseArea3, TILESET_FACILITY, INDOOR, LANDMARK_SAFARI_ZONE_KANTO, MUSIC_EVOLUTION, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SafariKantoRestHouseArea4, TILESET_FACILITY, INDOOR, LANDMARK_SAFARI_ZONE_KANTO, MUSIC_EVOLUTION, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SafariKantoSecretHouse, TILESET_FACILITY, INDOOR, LANDMARK_SAFARI_ZONE_KANTO, MUSIC_EVOLUTION, FALSE, PALETTE_DAY, FISHGROUP_SHORE
