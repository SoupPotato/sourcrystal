...
MapGroup_Dungeons:
	...
	map MountMoon1F, TILESET_CAVE, CAVE, LANDMARK_MT_MOON, MUSIC_MT_MOON, TRUE, PALETTE_NITE, FISHGROUP_LAKE
...
MapGroup_SafariZone:
	...
	map MountMoonB1F, TILESET_CAVE, CAVE, LANDMARK_MT_MOON, MUSIC_MT_MOON, TRUE, PALETTE_NITE, FISHGROUP_LAKE
