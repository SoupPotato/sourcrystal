...
MapGroup_Dungeons:
	...
	map SafariZoneFuchsiaGateBeta, TILESET_GATE, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_CERULEAN_CITY_HGSS, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map CliffEdgeGate, TILESET_CAVE, CAVE, LANDMARK_CLIFF_EDGE_GATE, MUSIC_ROUTE_36, TRUE, PALETTE_NITE, FISHGROUP_LAKE
...
MapGroup_Fuchsia:
	...
	map BillsBrothersHouse, TILESET_HOUSE, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_CERULEAN_CITY_HGSS, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_CableClub:
	...
	map MobileTradeRoom, TILESET_MANSION, INDOOR, LANDMARK_SPECIAL_MAP, MUSIC_CHERRYGROVE_CITY, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map MobileBattleRoom, TILESET_MANSION, INDOOR, LANDMARK_SPECIAL_MAP, MUSIC_CHERRYGROVE_CITY, TRUE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Cianwood:
	...
	map BattleTower1F, TILESET_BATTLE_TOWER, INDOOR, LANDMARK_BATTLE_TOWER, MUSIC_BATTLE_TOWER_LOBBY, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map BattleTowerBattleRoom, TILESET_BATTLE_TOWER, INDOOR, LANDMARK_BATTLE_TOWER, MUSIC_BATTLE_TOWER_THEME, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map BattleTowerElevator, TILESET_BATTLE_TOWER, INDOOR, LANDMARK_BATTLE_TOWER, MUSIC_NONE, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map BattleTowerHallway, TILESET_BATTLE_TOWER, INDOOR, LANDMARK_BATTLE_TOWER, MUSIC_BATTLE_TOWER_THEME, TRUE, PALETTE_DAY, FISHGROUP_SHORE
