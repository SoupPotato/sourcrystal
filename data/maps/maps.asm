...
MapGroup_Route47:
	...
	map YellowForest, TILESET_FOREST, ROUTE, YELLOW_FOREST, MUSIC_SAFARI_ZONE_GATE_HGSS, FALSE, PALETTE_AUTO, FISHGROUP_LAKE
	map YellowForestActualGate, TILESET_GATE, GATE, YELLOW_FOREST_GATE, MUSIC_SAFARI_ZONE_GATE_HGSS, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map YellowForestGate, TILESET_JOHTO, TOWN, YELLOW_FOREST_GATE, MUSIC_SAFARI_ZONE_GATE_HGSS, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map YellowForestGatePokecenter1F, TILESET_POKECENTER, INDOOR, YELLOW_FOREST_GATE, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
