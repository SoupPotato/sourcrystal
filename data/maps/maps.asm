...
MapGroup_Dungeons:
	...
	map CliffEdgeGate, TILESET_CAVE, CAVE, CLIFF_EDGE_GATE, MUSIC_ROUTE_36, TRUE, PALETTE_DAY, FISHGROUP_LAKE
...
MapGroup_Route47:
	map Route47, TILESET_JOHTO, ROUTE, ROUTE_47, MUSIC_ROUTE_47_HGSS, FALSE, PALETTE_AUTO, FISHGROUP_LAKE
