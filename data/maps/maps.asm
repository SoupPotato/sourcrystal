...
MapGroup_Olivine:
	...
	map OlivineCity, TILESET_JOHTO, TOWN, OLIVINE_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_AUTO, FISHGROUP_CHINCHOU
...
MapGroup_Dungeons:
	...
	map MountMoon, TILESET_CAVE, CAVE, MT_MOON, MUSIC_MT_MOON, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	...
	map SafariZoneFuchsiaGateBeta, TILESET_GATE, INDOOR, FUCHSIA_CITY, MUSIC_CERULEAN_CITY_HGSS, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map CliffEdgeGate, TILESET_CAVE, CAVE, CLIFF_EDGE_GATE, MUSIC_ROUTE_36, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map CliffCave, TILESET_CAVE, CAVE, CLIFF_CAVE, MUSIC_ROUTE_47_HGSS, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map CeruleanCave1F, TILESET_DARK_CAVE, CAVE, CERULEAN_CAVE, MUSIC_VICTORY_ROAD, TRUE, PALETTE_NITE | IN_DARKNESS, FISHGROUP_LAKE
	map CeruleanCave2F, TILESET_DARK_CAVE, CAVE, CERULEAN_CAVE, MUSIC_VICTORY_ROAD, TRUE, PALETTE_NITE | IN_DARKNESS, FISHGROUP_LAKE
	map CeruleanCaveB1F, TILESET_DARK_CAVE, CAVE, CERULEAN_CAVE, MUSIC_VICTORY_ROAD, TRUE, PALETTE_NITE | IN_DARKNESS, FISHGROUP_LAKE
...
MapGroup_Blackthorn:
	map BlackthornGym1F, TILESET_ELITE_FOUR_ROOM, INDOOR, BLACKTHORN_CITY, MUSIC_GYM, TRUE, PALETTE_NITE, FISHGROUP_SHORE
...
MapGroup_Cinnabar:
	...
	map SeafoamGym, TILESET_CAVE, CAVE, SEAFOAM_ISLANDS, MUSIC_GYM, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map SeafoamIslands, TILESET_CAVE, CAVE, SEAFOAM_ISLANDS, MUSIC_DARK_CAVE, TRUE, PALETTE_NITE, FISHGROUP_OCEAN
	map SeafoamIslandsB1F, TILESET_ICE_PATH, CAVE, SEAFOAM_ISLANDS, MUSIC_DARK_CAVE, TRUE, PALETTE_NITE, FISHGROUP_OCEAN
	map SeafoamIslandsB2F, TILESET_ICE_PATH, CAVE, SEAFOAM_ISLANDS, MUSIC_DARK_CAVE, TRUE, PALETTE_NITE, FISHGROUP_OCEAN
	map SeafoamIslandsB3F, TILESET_ICE_PATH, CAVE, SEAFOAM_ISLANDS, MUSIC_DARK_CAVE, TRUE, PALETTE_NITE, FISHGROUP_OCEAN
	map SeafoamIslandsB4F, TILESET_ICE_PATH, CAVE, SEAFOAM_ISLANDS, MUSIC_DARK_CAVE, TRUE, PALETTE_NITE, FISHGROUP_OCEAN
	map Route19, TILESET_KANTO, ROUTE, ROUTE_19, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_STARYU
	map Route20, TILESET_KANTO, ROUTE, ROUTE_20, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_SHELLDER
	map Route21, TILESET_KANTO, ROUTE, ROUTE_21, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map CinnabarIsland, TILESET_KANTO, TOWN, CINNABAR_ISLAND, MUSIC_CINNABAR_ISLAND_HGSS, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map PokemonMansion1F, TILESET_FACILITY, CAVE, POKEMON_MANSION, MUSIC_CINNABAR_MANSION, FALSE, PALETTE_NITE, FISHGROUP_OCEAN
	map PokemonMansionB1F, TILESET_FACILITY, CAVE, POKEMON_MANSION, MUSIC_CINNABAR_MANSION, FALSE, PALETTE_NITE, FISHGROUP_OCEAN

MapGroup_Cerulean:
	map CeruleanGymBadgeSpeechHouse, TILESET_HOUSE, INDOOR, CERULEAN_CITY, MUSIC_CERULEAN_CITY_HGSS, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeruleanPoliceStation, TILESET_HOUSE, INDOOR, CERULEAN_CITY, MUSIC_CERULEAN_CITY_HGSS, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeruleanTradeSpeechHouse, TILESET_HOUSE, INDOOR, CERULEAN_CITY, MUSIC_CERULEAN_CITY_HGSS, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map CeruleanMart, TILESET_MART, INDOOR, CERULEAN_CITY, MUSIC_CERULEAN_CITY_HGSS, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map Route24, TILESET_KANTO, ROUTE, ROUTE_24, MUSIC_NUGGET_BRIDGE_HGSS, FALSE, PALETTE_AUTO, FISHGROUP_LAKE
	map Route25, TILESET_KANTO, ROUTE, ROUTE_25, MUSIC_NUGGET_BRIDGE_HGSS, FALSE, PALETTE_AUTO, FISHGROUP_LAKE
	map CeruleanCity, TILESET_KANTO, TOWN, CERULEAN_CITY, MUSIC_CERULEAN_CITY_HGSS, FALSE, PALETTE_AUTO, FISHGROUP_NONE
...
MapGroup_Vermilion:
	...
	map Route11Gate, TILESET_GATE, GATE, ROUTE_11, MUSIC_ROUTE_12, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Pewter:
	...
	map PewterMuseum1F, TILESET_GATE, INDOOR, PEWTER_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PewterMuseum2F, TILESET_GATE, INDOOR, PEWTER_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map MountMoonPokecenter1F, TILESET_POKECENTER, INDOOR, ROUTE_3, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route2North, TILESET_KANTO, ROUTE, ROUTE_2, MUSIC_ROUTE_1, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_FastShip:
	...
	map BlackthornGym2F, TILESET_ELITE_FOUR_ROOM, INDOOR, BLACKTHORN_CITY, MUSIC_GYM, TRUE, PALETTE_NITE, FISHGROUP_SHORE
...
MapGroup_Fuchsia:
	...
	map FuchsiaCity, TILESET_KANTO, TOWN, FUCHSIA_CITY, MUSIC_CERULEAN_CITY_HGSS, FALSE, PALETTE_AUTO, FISHGROUP_GYARADOS
	map FuchsiaMart, TILESET_MART, INDOOR, FUCHSIA_CITY, MUSIC_CERULEAN_CITY_HGSS, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SafariZoneMainOffice, TILESET_GAME_CORNER, INDOOR, FUCHSIA_CITY, MUSIC_CERULEAN_CITY_HGSS, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map FuchsiaGym, TILESET_LAB, INDOOR, FUCHSIA_CITY, MUSIC_GYM, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map BillsBrothersHouse, TILESET_HOUSE, INDOOR, FUCHSIA_CITY, MUSIC_CERULEAN_CITY_HGSS, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map FuchsiaPokecenter1F, TILESET_POKECENTER, INDOOR, FUCHSIA_CITY, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map FuchsiaPokecenter2FBeta, TILESET_POKECENTER, INDOOR, FUCHSIA_CITY, MUSIC_CERULEAN_CITY_HGSS, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SafariZoneWardensHome, TILESET_HOUSE, INDOOR, FUCHSIA_CITY, MUSIC_CERULEAN_CITY_HGSS, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Cianwood:
	...
	map Route41, TILESET_JOHTO, ROUTE, ROUTE_41, MUSIC_ROUTE_36, FALSE, PALETTE_AUTO, FISHGROUP_HORSEA
...
MapGroup_Viridian:
	map Route2South, TILESET_KANTO, ROUTE, ROUTE_2, MUSIC_ROUTE_1, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	...
	map ViridianGym, TILESET_TRAIN_STATION, DUNGEON, VIRIDIAN_CITY, MUSIC_GYM, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map ViridianForest, TILESET_FOREST, ROUTE, VIRIDIAN_FOREST, MUSIC_ROUTE_2, FALSE, PALETTE_NITE, FISHGROUP_SHORE
	map ViridianForestGateN, TILESET_GATE, GATE, ROUTE_2, MUSIC_ROUTE_1, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map ViridianForestGateS, TILESET_GATE, GATE, ROUTE_2, MUSIC_ROUTE_1, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Route47:
	map Route47, TILESET_JOHTO, ROUTE, ROUTE_47, MUSIC_ROUTE_47_HGSS, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map Route48, TILESET_JOHTO, ROUTE, ROUTE_48, MUSIC_ROUTE_47_HGSS, FALSE, PALETTE_AUTO, FISHGROUP_LAKE
	map SafariZoneEntrance, TILESET_GATE, GATE, SAFARI_ZONE_GATE, MUSIC_SAFARI_ZONE_GATE_HGSS, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SafariZoneGate, TILESET_JOHTO, TOWN, SAFARI_ZONE_GATE, MUSIC_SAFARI_ZONE_GATE_HGSS, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map SafariZoneGatePokecenter1F, TILESET_POKECENTER, INDOOR, SAFARI_ZONE_GATE, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SafariZoneArea1, TILESET_PARK, ROUTE, SAFARI_ZONE, MUSIC_EVOLUTION, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map SafariZoneArea2, TILESET_PARK, ROUTE, SAFARI_ZONE, MUSIC_EVOLUTION, FALSE, PALETTE_AUTO, FISHGROUP_LAKE
	map SafariZoneArea4, TILESET_FOREST, ROUTE, SAFARI_ZONE, MUSIC_EVOLUTION, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map SafariRestHouseArea1, TILESET_FACILITY, INDOOR, SAFARI_ZONE, MUSIC_EVOLUTION, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SafariRestHouseArea2, TILESET_FACILITY, INDOOR, SAFARI_ZONE, MUSIC_EVOLUTION, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SafariRestHouseArea3, TILESET_FACILITY, INDOOR, SAFARI_ZONE, MUSIC_EVOLUTION, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SafariRestHouseArea4, TILESET_FACILITY, INDOOR, SAFARI_ZONE, MUSIC_EVOLUTION, FALSE, PALETTE_DAY, FISHGROUP_SHORE

MapGroup_Safari_Spec:
	map SafariZoneArea3, TILESET_PARK, ROUTE, SAFARI_ZONE, MUSIC_EVOLUTION, FALSE, PALETTE_AUTO, FISHGROUP_POND
