...
; entries correspond to constants/move_constants.asm
	...
	move LOW_KICK,     EFFECT_FLINCH_HIT,         50, FIGHTING, 100, 20,  30 ; OLD ACCURACY: 90
	...
	move FIRE_SPIN,    EFFECT_TRAP_TARGET,        35, FIRE,      85, 15,   0 ; OLD POWER: 15, OLD ACCURACY: 70
	...
	move CLAMP,        EFFECT_TRAP_TARGET,        35, WATER,     85, 15,   0 ; OLD PP: 10, OLD ACCURACY: 75
	...
	move WHIRLPOOL,    EFFECT_TRAP_TARGET,        35, WATER,     85, 15,   0 ; OLD POWER: 15, OLD ACCURACY: 70
