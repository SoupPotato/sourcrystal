...
; entries correspond to move ids (see constants/move_constants.asm)
	...
	move RAZOR_WIND,   EFFECT_RAZOR_WIND,         80, NORMAL,       100, 10,   0 ; OLD ACCURACY: 75
	...
	move FLY,          EFFECT_FLY,                90, FLYING,        95, 15,   0 ; OLD POWER: 70
	move BIND,         EFFECT_TRAP_TARGET,        15, NORMAL,        85, 20, 100 ; OLD ACCURACY: 75
	move SLAM,         EFFECT_NORMAL_HIT,         80, NORMAL,        75, 20,   0
	move VINE_WHIP,    EFFECT_NORMAL_HIT,         45, GRASS,        100, 25,   0 ; OLD POWER: 35, OLD PP: 10
	...
	move JUMP_KICK,    EFFECT_JUMP_KICK,         100, FIGHTING,      95, 10,   0 ; OLD POWER: 70, OLD PP: 25
	...
	move MIST,         EFFECT_MIST,                0, ICE,            0, 30,   0
	...
	move GROWTH,       EFFECT_GROWTH,              0, NORMAL,         0, 20,   0 ; OLD PP: 40
	...
	move MEDITATE,     EFFECT_ATTACK_UP,           0, PSYCHIC_TYPE,   0, 40,   0
	move AGILITY,      EFFECT_SPEED_UP_2,          0, PSYCHIC_TYPE,   0, 30,   0
	move QUICK_ATTACK, EFFECT_PRIORITY_HIT,       40, NORMAL,       100, 30,   0
	move RAGE,         EFFECT_RAGE,               20, NORMAL,       100, 20,   0
	move TELEPORT,     EFFECT_TELEPORT,            0, PSYCHIC_TYPE,   0, 20,   0
	move NIGHT_SHADE,  EFFECT_LEVEL_DAMAGE,        1, GHOST,        100, 15,   0
	move MIMIC,        EFFECT_MIMIC,               0, NORMAL,         0, 10,   0
	move SCREECH,      EFFECT_DEFENSE_DOWN_2,      0, NORMAL,        85, 40,   0
	move DOUBLE_TEAM,  EFFECT_EVASION_UP,          0, NORMAL,         0, 15,   0
	move RECOVER,      EFFECT_HEAL,                0, NORMAL,       100, 10,   0 ; OLD PP: 20
	move HARDEN,       EFFECT_DEFENSE_UP,          0, NORMAL,         0, 30,   0
	move MINIMIZE,     EFFECT_EVASION_UP_2,        0, NORMAL,         0, 20,   0 ; OLD EFFECT: EFFECT_EVASION_UP
	move SMOKESCREEN,  EFFECT_ACCURACY_DOWN,       0, NORMAL,       100, 20,   0
	move CONFUSE_RAY,  EFFECT_CONFUSE,             0, GHOST,        100, 10,   0
	move WITHDRAW,     EFFECT_DEFENSE_UP,          0, WATER,          0, 40,   0
	move DEFENSE_CURL, EFFECT_DEFENSE_CURL,        0, NORMAL,         0, 40,   0
	move BARRIER,      EFFECT_DEFENSE_UP_2,        0, PSYCHIC_TYPE,   0, 20,   0 ; OLD PP: 30
	move LIGHT_SCREEN, EFFECT_LIGHT_SCREEN,        0, PSYCHIC_TYPE,   0, 30,   0
	move HAZE,         EFFECT_RESET_STATS,         0, ICE,            0, 30,   0
	move REFLECT,      EFFECT_REFLECT,             0, PSYCHIC_TYPE,   0, 20,   0
	move FOCUS_ENERGY, EFFECT_FOCUS_ENERGY,        0, NORMAL,         0, 30,   0
	move BIDE,         EFFECT_BIDE,                0, NORMAL,         0, 10,   0
	move METRONOME,    EFFECT_METRONOME,           0, NORMAL,         0, 10,   0
	move MIRROR_MOVE,  EFFECT_MIRROR_MOVE,         0, FLYING,         0, 20,   0
	...
	move SWIFT,        EFFECT_ALWAYS_HIT,         60, NORMAL,         0, 20,   0
	...
	move AMNESIA,      EFFECT_SP_DEF_UP_2,         0, PSYCHIC_TYPE,   0, 20,   0
	move KINESIS,      EFFECT_ACCURACY_DOWN,       0, PSYCHIC_TYPE,  80, 15,   0
	move SOFTBOILED,   EFFECT_HEAL,                0, NORMAL,         0, 10,   0
	move HI_JUMP_KICK, EFFECT_JUMP_KICK,         130, FIGHTING,      90, 10,   0 ; OLD POWER: 85, OLD PP: 20
	...
	move TRANSFORM,    EFFECT_TRANSFORM,           0, NORMAL,         0, 10,   0
	...
	move SPLASH,       EFFECT_SPLASH,              0, NORMAL,         0, 40,   0
	move ACID_ARMOR,   EFFECT_DEFENSE_UP_2,        0, POISON,         0, 20,   0 ; OLD PP: 40
	...
	move REST,         EFFECT_HEAL,                0, PSYCHIC_TYPE,   0, 10,   0
	move ROCK_SLIDE,   EFFECT_FLINCH_HIT,         75, ROCK,          90, 10,  30
	move HYPER_FANG,   EFFECT_FLINCH_HIT,         80, NORMAL,        90, 15,  10
	move SHARPEN,      EFFECT_ATTACK_UP,           0, NORMAL,         0, 30,   0
	move CONVERSION,   EFFECT_CONVERSION,          0, NORMAL,         0, 30,   0
	...
	move SUBSTITUTE,   EFFECT_SUBSTITUTE,          0, NORMAL,         0, 10,   0
	move STRUGGLE,     EFFECT_STRUGGLE,           50, NORMAL,         0,  1,   0
	move SKETCH,       EFFECT_SKETCH,              0, NORMAL,       100,  1,   0
	move TRIPLE_KICK,  EFFECT_TRIPLE_KICK,         1, FIGHTING,      90, 10,   0
	move THIEF,        EFFECT_THIEF,              60, DARK,         100, 25, 100 ; OLD POWER: 40, OLD PP: 10
	move SPIDER_WEB,   EFFECT_MEAN_LOOK,           0, BUG,          100, 10,   0
	move MIND_READER,  EFFECT_LOCK_ON,             0, NORMAL,         0,  5,   0
	...
	move CURSE,        EFFECT_CURSE,               0, CURSE_TYPE,     0, 10,   0
	move FLAIL,        EFFECT_REVERSAL,            1, NORMAL,       100, 15,   0
	move CONVERSION2,  EFFECT_CONVERSION2,         0, NORMAL,         0, 30,   0
	...
	move PROTECT,      EFFECT_PROTECT,             0, NORMAL,         0, 10,   0
	...
	move FEINT_ATTACK, EFFECT_ALWAYS_HIT,         60, DARK,           0, 20,   0
	move SWEET_KISS,   EFFECT_CONFUSE,             0, NORMAL,        75, 10,   0
	move BELLY_DRUM,   EFFECT_BELLY_DRUM,          0, NORMAL,         0, 10,   0
	...
	move SPIKES,       EFFECT_SPIKES,              0, GROUND,         0, 20,   0
	move ZAP_CANNON,   EFFECT_PARALYZE_HIT,      120, ELECTRIC,      50,  5, 100 ; OLD POWER: 100
	move FORESIGHT,    EFFECT_FORESIGHT,           0, NORMAL,         0, 40,   0
	move DESTINY_BOND, EFFECT_DESTINY_BOND,        0, GHOST,          0,  5,   0
	move PERISH_SONG,  EFFECT_PERISH_SONG,         0, NORMAL,         0,  5,   0
	move ICY_WIND,     EFFECT_SPEED_DOWN_HIT,     55, ICE,           95, 15, 100
	move DETECT,       EFFECT_PROTECT,             0, FIGHTING,       0,  5,   0
	move BONE_RUSH,    EFFECT_MULTI_HIT,          25, GROUND,        90, 10,   0 ; OLD ACCURACY: 80
	move LOCK_ON,      EFFECT_LOCK_ON,             0, NORMAL,         0,  5,   0
	move OUTRAGE,      EFFECT_RAMPAGE,           120, DRAGON,       100, 10,   0 ; OLD POWER: 90, OLD PP: 15
	move SANDSTORM,    EFFECT_SANDSTORM,           0, ROCK,           0, 10,   0
	move GIGA_DRAIN,   EFFECT_LEECH_HIT,          75, GRASS,        100, 10,   0 ; OLD POWER: 60, OLD PP: 5
	move ENDURE,       EFFECT_ENDURE,              0, NORMAL,         0, 10,   0
	...
	move MILK_DRINK,   EFFECT_HEAL,                0, NORMAL,         0, 10,   0
	...
	move MEAN_LOOK,    EFFECT_MEAN_LOOK,           0, NORMAL,         0,  5,   0
	move ATTRACT,      EFFECT_ATTRACT,             0, NORMAL,       100, 15,   0
	move SLEEP_TALK,   EFFECT_SLEEP_TALK,          0, NORMAL,         0, 10,   0
	move HEAL_BELL,    EFFECT_HEAL_BELL,           0, NORMAL,         0,  5,   0
	...
	move SAFEGUARD,    EFFECT_SAFEGUARD,           0, NORMAL,         0, 25,   0
	move PAIN_SPLIT,   EFFECT_PAIN_SPLIT,          0, NORMAL,         0, 20,   0
	...
	move BATON_PASS,   EFFECT_BATON_PASS,          0, NORMAL,         0, 40,   0
	...
	move VITAL_THROW,  EFFECT_ALWAYS_HIT,         70, FIGHTING,       0, 10,   0
	move MORNING_SUN,  EFFECT_MORNING_SUN,         0, NORMAL,         0,  5,   0 ; NOTE: Regular heal is 1/2 max hp
	move SYNTHESIS,    EFFECT_SYNTHESIS,           0, GRASS,          0,  5,   0 ; NOTE: Regular heal is 1/2 max hp
	move MOONLIGHT,    EFFECT_MOONLIGHT,           0, NORMAL,         0,  5,   0 ; NOTE: Regular heal is 1/2 max hp
	...
	move PSYCH_UP,     EFFECT_PSYCH_UP,            0, NORMAL,         0, 10,   0
	...
	move BEAT_UP,      EFFECT_BEAT_UP,             1, DARK,         100, 10,   0 ; OLD POWER: 10
