...
ReeseWantsRematchText:
	text "Whoa…"
	para "I can't believe"
	line "how buffed up I"
	cont "am now."
	
	para "I'll be showing"
	line "off my moves on"
	cont "@"
	text_from_ram wStringBuffer5
	text ","
	
	para "so come by and get"
	line "stomped!"
	
	para "I'll be waiting to"
	line "show you!"
	done
