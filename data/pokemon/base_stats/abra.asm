	...
	; tm/hm learnset
	tmhm DYNAMICPUNCH, HEADBUTT, CURSE, TOXIC, ZAP_CANNON, PSYCH_UP, HIDDEN_POWER, SUNNY_DAY, SNORE, PROTECT, RAIN_DANCE, ENDURE, FRUSTRATION, IRON_TAIL, RETURN, PSYCHIC_M, SHADOW_BALL, DOUBLE_TEAM, ICE_PUNCH, SWAGGER, SLEEP_TALK, THUNDERPUNCH, DREAM_EATER, REST, ATTRACT, THIEF, FIRE_PUNCH, NIGHTMARE, FLASH, TELEPORT, MEGA_PUNCH, PSYWAVE, SEISMIC_TOSS, REFLECT, MEGA_KICK, BODY_SLAM, MIMIC, THUNDER_WAVE, TRI_ATTACK, SUBSTITUTE, METRONOME, DOUBLE_EDGE
	; end
