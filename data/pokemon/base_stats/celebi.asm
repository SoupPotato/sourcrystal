	...
	; tm/hm learnset
	tmhm CURSE, TOXIC, PSYCH_UP, HIDDEN_POWER, SUNNY_DAY, SWEET_SCENT, SNORE, HYPER_BEAM, PROTECT, RAIN_DANCE, GIGA_DRAIN, ENDURE, FRUSTRATION, SOLARBEAM, RETURN, PSYCHIC_M, SHADOW_BALL, MUD_SLAP, DOUBLE_TEAM, SWAGGER, SLEEP_TALK, SANDSTORM, SWIFT, DEFENSE_CURL, DREAM_EATER, REST, NIGHTMARE, FLASH, TELEPORT, PSYWAVE, BUBBLEBEAM, REFLECT, MIMIC, THUNDER_WAVE, MEGA_DRAIN, SUBSTITUTE, METRONOME, SWORDS_DANCE, DOUBLE_EDGE
	; end
