	...
	; tm/hm learnset
	tmhm DYNAMICPUNCH, HEADBUTT, CURSE, TOXIC, ROCK_SMASH, HIDDEN_POWER, SUNNY_DAY, SNORE, PROTECT, RAIN_DANCE, ENDURE, FRUSTRATION, EARTHQUAKE, RETURN, MUD_SLAP, DOUBLE_TEAM, SWAGGER, SLEEP_TALK, SWIFT, LOW_KICK, REST, ATTRACT, THIEF, STRENGTH, MEGA_PUNCH, SEISMIC_TOSS, MEGA_KICK, BODY_SLAM, MIMIC, SUBSTITUTE, METRONOME, ROCK_SLIDE, SWORDS_DANCE, DOUBLE_EDGE
	; end
