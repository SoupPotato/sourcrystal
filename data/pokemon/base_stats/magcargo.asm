	...
	; tm/hm learnset
	tmhm CURSE, ROLLOUT, TOXIC, ROCK_SMASH, HIDDEN_POWER, SUNNY_DAY, SNORE, HYPER_BEAM, PROTECT, ENDURE, FRUSTRATION, SOLARBEAM, EARTHQUAKE, RETURN, MUD_SLAP, DOUBLE_TEAM, SWAGGER, SLEEP_TALK, SANDSTORM, FIRE_BLAST, SANDSTORM, DEFENSE_CURL, REST, ATTRACT, STRENGTH, FLAMETHROWER, REFLECT, BODY_SLAM, MIMIC, SELFDESTRUCT, SUBSTITUTE, ROCK_SLIDE, DOUBLE_EDGE, EXPLOSION
	; end
