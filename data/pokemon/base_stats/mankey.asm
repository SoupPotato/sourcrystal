	...
	; tm/hm learnset
	tmhm DYNAMICPUNCH, HEADBUTT, CURSE, TOXIC, ROCK_SMASH, PSYCH_UP, HIDDEN_POWER, SUNNY_DAY, SNORE, PROTECT, RAIN_DANCE, ENDURE, FRUSTRATION, IRON_TAIL, THUNDER, EARTHQUAKE, RETURN, DIG, MUD_SLAP, DOUBLE_TEAM, ICE_PUNCH, SWAGGER, SLEEP_TALK, SWIFT, DEFENSE_CURL, THUNDERPUNCH, LOW_KICK, REST, ATTRACT, THIEF, FIRE_PUNCH, STRENGTH, THUNDERBOLT, PAY_DAY, MEGA_PUNCH, SEISMIC_TOSS, MEGA_KICK, BODY_SLAM, MIMIC, SUBSTITUTE, METRONOME, ROCK_SLIDE, DOUBLE_EDGE
	; end
