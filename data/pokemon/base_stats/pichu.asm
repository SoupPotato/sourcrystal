	...
	; tm/hm learnset
	tmhm HEADBUTT, CURSE, ROLLOUT, TOXIC, ZAP_CANNON, HIDDEN_POWER, SNORE, PROTECT, RAIN_DANCE, ENDURE, FRUSTRATION, IRON_TAIL, THUNDER, RETURN, MUD_SLAP, DOUBLE_TEAM, SWAGGER, SLEEP_TALK, SWIFT, DEFENSE_CURL, THUNDERPUNCH, REST, ATTRACT, FLASH, THUNDERBOLT, MEGA_PUNCH, SEISMIC_TOSS, MEGA_KICK, BODY_SLAM, MIMIC, THUNDER_WAVE, SUBSTITUTE, DOUBLE_EDGE
	; end
