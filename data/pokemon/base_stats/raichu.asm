	...
	; tm/hm learnset
	tmhm DYNAMICPUNCH, HEADBUTT, CURSE, ROLLOUT, TOXIC, ZAP_CANNON, ROCK_SMASH, HIDDEN_POWER, SNORE, HYPER_BEAM, PROTECT, RAIN_DANCE, ENDURE, FRUSTRATION, IRON_TAIL, THUNDER, RETURN, DIG, MUD_SLAP, DOUBLE_TEAM, SWAGGER, SLEEP_TALK, SWIFT, DEFENSE_CURL, THUNDERPUNCH, REST, ATTRACT, THIEF, STRENGTH, FLASH, THUNDERBOLT, PAY_DAY, MEGA_PUNCH, SEISMIC_TOSS, MEGA_KICK, BODY_SLAM, MIMIC, THUNDER_WAVE, SUBSTITUTE, DOUBLE_EDGE
	; end
