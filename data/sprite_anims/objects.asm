...
; SPRITE_ANIM_OBJ_PC_PACK
	...
	db SPRITE_ANIM_FRAMESET_FLY_MON,                  SPRITE_ANIM_FUNC_NULL,                    SPRITE_ANIM_DICT_DEFAULT ; SPRITE_ANIM_INDEX_FLY_MON
	db SPRITE_ANIM_FRAMESET_SLOTS_COVER_WHITE,        SPRITE_ANIM_FUNC_COVER,                   SPRITE_ANIM_DICT_SLOTS ; SPRITE_ANIM_OBJ_SLOTS_COVER
	db SPRITE_ANIM_FRAMESET_4X4_X_FLIP, SPRITE_ANIM_FUNC_ITEMFINDER, SPRITE_ANIM_DICT_DEFAULT ; SPRITE_ANIM_OBJ_ITEMFINDER
