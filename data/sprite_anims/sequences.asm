...
; entries correspond to SPRITE_ANIM_INDEX_* constants
	...
	db SPRITE_ANIM_FRAMESET_PAGER_MON_RED,            SPRITE_ANIM_SEQ_PAGER_MON,               $00 ; SPRITE_ANIM_INDEX_PAGER_MON_RED
	db SPRITE_ANIM_FRAMESET_PAGER_MON_BLUE,           SPRITE_ANIM_SEQ_PAGER_MON,               $00 ; SPRITE_ANIM_INDEX_PAGER_MON_BLUE
	db SPRITE_ANIM_FRAMESET_PAGER_MON_GREEN,          SPRITE_ANIM_SEQ_PAGER_MON,               $00 ; SPRITE_ANIM_INDEX_PAGER_MON_GREEN
	db SPRITE_ANIM_FRAMESET_PAGER_MON_BROWN,          SPRITE_ANIM_SEQ_PAGER_MON,               $00 ; SPRITE_ANIM_INDEX_PAGER_MON_BROWN
	db SPRITE_ANIM_FRAMESET_PAGER_MON_GREY,           SPRITE_ANIM_SEQ_PAGER_MON,               $00 ; SPRITE_ANIM_INDEX_PAGER_MON_GREY
