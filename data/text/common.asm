...
SECTION "_OakTimeNappedText", ROMX
_OakTimeNappedText::
	text "!"
	line "I napped for"
	cont "too long!"
...
SECTION "_ThePasswordIsText", ROMX
_ThePasswordIsText:: ; unreferenced
	text "The password is:"
	line ""
	done

SECTION "_IsThisOKText", ROMX
_IsThisOKText:: ; unreferenced
	text "Is this OK?"
	done

SECTION "_EnterTheIDNoText", ROMX
_EnterTheIDNoText:: ; unreferenced
	text "Enter the"
	line "ID no."
	done

SECTION "_EnterTheAmountText", ROMX
...
SECTION "_OPT_SwarmText6", ROMX
_OPT_SwarmText6::
	text_start
	line "If any trainers"
	done

SECTION "_OPT_SwarmText7", ROMX
_OPT_SwarmText7::
	text_start
	line "want to catch"
	done

SECTION "_OPT_SwarmText8", ROMX
_OPT_SwarmText8::
	text_start
	line "a @"
	text_from_ram wMonOrItemNameBuffer
...
SECTION "_OPT_SwarmText9", ROMX
_OPT_SwarmText9::
	text_start
	line "then head over to"
	done

SECTION "_OPT_SwarmText10", ROMX
_OPT_SwarmText10::
	text_start
	line "Now, let's start"
	done

SECTION "_OPT_SwarmText11", ROMX
_OPT_SwarmText11::
	text_start
	line "the show!"
	done
...
SECTION "_ThatCantBeUsedRightNowText", ROMX
_ThatCantBeUsedRightNowText:: ; unreferenced
	text "That can't be used"
	line "right now."
	prompt

SECTION "_ThatItemCantBePutInThePackText", ROMX
_ThatItemCantBePutInThePackText:: ; unreferenced
	text "That item can't be"
	line "put in the PACK."
	done

SECTION "_TheItemWasPutInThePackText", ROMX
...
SECTION "_RemainingTimeText", ROMX
_RemainingTimeText:: ; unreferenced
	text "Remaining Time"
	done

SECTION "_YourMonsHPWasHealedText", ROMX
_YourMonsHPWasHealedText:: ; unreferenced
	text "Your #MON's HP"
	line "was healed."
	prompt

SECTION "_WarpingText", ROMX
_WarpingText:: ; unreferenced
	text "Warping…"
	done

SECTION "_ChangeWhichNumberText", ROMX
_ChangeWhichNumberText:: ; unreferenced
	text "Which number"
	line "should be changed?"
	done

SECTION "_WillYouPlayWithMonText", ROMX
...
SECTION "_YouNeedTwoMonForBreedingText", ROMX
_YouNeedTwoMonForBreedingText:: ; unreferenced
	text "You need two #-"
	line "MON for breeding."
	prompt

SECTION "_BreedingIsNotPossibleText", ROMX
_BreedingIsNotPossibleText:: ; unreferenced
	text "Breeding is not"
	line "possible."
	prompt

SECTION "_CompatibilityShouldTheyBreedText", ROMX
...
SECTION "_ThereIsNoEggText", ROMX
_ThereIsNoEggText:: ; unreferenced
	text "There is no EGG."
	line ""
	prompt

SECTION "_ItsGoingToHatchText", ROMX
_ItsGoingToHatchText:: ; unreferenced
	text "It's going to"
	line "hatch!"
	prompt

SECTION "_TestEventText", ROMX
...
SECTION "_StartText", ROMX
_StartText:: ; unreferenced
	text "Start!"
	done

SECTION "_EndText", ROMX
_EndText:: ; unreferenced
	text "End!"
	done

SECTION "_ForABoyText", ROMX
_ForABoyText:: ; unreferenced
	text "For a boy!"
	done

SECTION "_ForAGirlText", ROMX
_ForAGirlText:: ; unreferenced
	text "For a girl!"
	done

SECTION "_DoesntConcernABoyText", ROMX
_DoesntConcernABoyText:: ; unreferenced
	text "This doesn't"
	line "concern a boy!"
	done

SECTION "_TheBoxIsFullText", ROMX
...
SECTION "_NewCardArrivedText", ROMX
_NewCardArrivedText::
...
SECTION "_PutCardInCardFolderText", ROMX
_PutCardInCardFolderText::
	text "Put this CARD in"
	line "the CARD FOLDER?"
	done

SECTION "_CardWasListedText", ROMX
_CardWasListedText::
	text_ram wStringBuffer2
	text "'s CARD was"
	line "listed as no.@"
...
SECTION "_StartingLinkText", ROMX
_StartingLinkText::
	text "Starting link."
	done

SECTION "_LinkTerminatedText", ROMX
_LinkTerminatedText::
	text "Link terminated."
	done

SECTION "_ClosingLinkText", ROMX
_ClosingLinkText::
	text "Closing link."
	done

SECTION "_ClearTimeLimitText", ROMX
_ClearTimeLimitText:: ; unreferenced
	text "Clear the time"
	line "limit?"
	done

SECTION "_TimeLimitWasClearedText", ROMX
_TimeLimitWasClearedText:: ; unreferenced
	text "The time limit was"
	line "cleared."
	done

SECTION "_PickErrorPacketText", ROMX
_PickErrorPacketText:: ; unreferenced
	text "Pick which packet"
	line "as an error?"
	done

SECTION "_TradingMonForOTMonText", ROMX
...
SECTION "_ObtainedTheVoltorbBadgeText", ROMX
...
SECTION "_SafariTimeUpText", ROMX
_SafariTimeUpText::
	text "PA: Ding-dong!"
...
SECTION "_SafariGameOverText", ROMX
_SafariGameOverText::
	text "PA: Your SAFARI"
	line "Game is over!"
	done

SECTION "_SafariOutOfBallsText", ROMX
...
SECTION "_GoMonText", ROMX
_GoMonText::
	text "Go! @"
	text_end

SECTION "_DoItMonText", ROMX
_DoItMonText::
	text "Do it! @"
	text_end

SECTION "_GoForItMonText", ROMX
_GoForItMonText::
	text "Go for it,"
	line "@"
	text_end

SECTION "_YourFoesWeakGetmMonText", ROMX
...
SECTION "_BattleMonNickCommaText", ROMX
...
SECTION "_NameCardReceivedCardText", ROMX
...
SECTION "_NameCardListedCardText", ROMX
...
SECTION "_NameCardNotRegisteredCardText", ROMX
_NameCardNotRegisteredCardText::
	text "The CARD was not"
	line "registered."
	prompt

SECTION "_NameCardLinkCancelledText", ROMX
_NameCardLinkCancelledText::
	text "The link has been"
	line "cancelled."
	prompt

SECTION "_NameCardLinkCommErrorText", ROMX
...
SECTION "_BlindingFlashPagerText", ROMX
...
SECTION "_UsedSurfPagerText", ROMX
_UsedSurfPagerText::
	text "<PLAYER> summoned a"
	line "LAPRAS to use"
	cont "SURF!"
...
SECTION "_AskSurfPagerText", ROMX
_AskSurfPagerText::
	text "The water is calm."
	line "Want to use"
	cont "LAPRAS SURF?"
...
SECTION "_UsedFlyPagerText", ROMX
_UsedFlyPagerText::
	text "<PLAYER> summoned a"
	line "PIDGEOT to use"
	cont "FLY!"
...
SECTION "_UseStrengthPagerText", ROMX
...
SECTION "_MoveBoulderPagerText", ROMX
_MoveBoulderPagerText::
	text "MACHOKE can"
	line "move boulders."
	prompt

SECTION "_AskStrengthPagerText", ROMX
...
SECTION "_UseWhirlpoolPagerText", ROMX
...
SECTION "_AskWhirlpoolPagerText", ROMX
...
SECTION "_UseRockSmashPagerText", ROMX
...
SECTION "_AskRockSmashPagerText", ROMX
...
SECTION "Text_ThisGameHasTwoGameModes", ROMX
...
SECTION "Text_NormalModeDesc", ROMX
Text_NormalModeDesc::
	text "#MON levels"
	line "remain unchanged."
	done

SECTION "Text_ChallengeModeDesc", ROMX
Text_ChallengeModeDesc::
	text "Higher #MON"
	line "levels."
	done

SECTION "Text_ThisCannotBeChanged", ROMX
...
SECTION "_UsedMove1Text", ROMX
_UsedMove1Text::
	text_start
	line "used @"
	text_end

SECTION "_UsedMove2Text", ROMX
_UsedMove2Text::
	text_start
	line "used @"
	text_end
...
SECTION "_EndUsedMove1Text", ROMX
_EndUsedMove1Text::
	text "!"
	done

SECTION "_EndUsedMove2Text", ROMX
_EndUsedMove2Text::
	text "!"
	done

SECTION "_EndUsedMove3Text", ROMX
_EndUsedMove3Text::
	text "!"
	done

SECTION "_EndUsedMove4Text", ROMX
_EndUsedMove4Text::
	text "!"
	done

SECTION "_EndUsedMove5Text", ROMX
_EndUsedMove5Text::
	text "!"
	done
...
SECTION "EndTheSafariGame_text", ROMX
...
SECTION "_CantPlaceMailInStorageText", ROMX
...
SECTION "_MobileBattleMustPickThreeMonText", ROMX
...
SECTION "_MobileBattleMoreInfoText", ROMX
_MobileBattleMoreInfoText::
	text "Need more info on"
	line "mobile battles?"
	done

SECTION "_MobileBattleRulesText", ROMX
...
SECTION "_WouldYouLikeToMobileBattleText", ROMX
...
SECTION "_WantAQuickMobileBattleText", ROMX
...
SECTION "_WantToRushThroughAMobileBattleText", ROMX
...
SECTION "_PleaseTryAgainTomorrowText", ROMX
...
SECTION "_TryAgainUsingSameSettingsText", ROMX
...
SECTION "_PickThreeMonForMobileBattleText", ROMX
_PickThreeMonForMobileBattleText::
	text "Pick three #MON"
	line "for battle."
	done

SECTION "_MobileBattleRemainingTimeText", ROMX
...
SECTION "_CorruptedEventText", ROMX
...
SECTION "_MobilePickThreeMonForBattleText", ROMX
...
SECTION "_SpaceSpaceColonText", ROMX
...
SECTION "_PokegearSelectPagerText", ROMX
...
SECTION "_DatabaseFullText", ROMX
_DatabaseFullText::
