...
; SafariKanto1
	table_width 4
; morning
	db 20, NIDORAN_F,   32, 32
	db 20, NIDORAN_M,   32, 32
	db 15, EXEGGCUTE,   34, 34
	db 10, NIDORINO,    41, 41
	db 10, PARAS,       37, 37
	db 10, RHYHORN,     35, 35
	db  5, NATU,        37, 37
	db  5, PARASECT,    42, 42
	db  4, HERACROSS,   38, 38
	db  1, CHANSEY,     37, 37
; day/eve  
	db 20, NIDORAN_F,   32, 32
	db 20, NIDORAN_M,   32, 32
...
; SafariKanto1
	table_width 4
; morning
	db 20, NIDORAN_F,   34, 34
	db 20, NIDORAN_M,   34, 34
	db 15, EXEGGCUTE,   36, 36
	db 10, DODUO,       36, 36
	db 10, NIDORINA,    42, 42
	db 10, PARASECT,    38, 38
	db  5, SKARMORY,    37, 37
	db  5, TAUROS,      38, 38
	db  4, SCYTHER,     38, 38
	db  1, GIRAFARIG,   37, 37
; day/eve  
	db 20, NIDORAN_F,   34, 34
	db 20, NIDORAN_M,   34, 34
	db 15, EXEGGCUTE,   36, 36
...
; morning
	db 20, NIDORAN_F,   32, 32
	db 20, NIDORAN_M,   32, 32
	db 15, EXEGGCUTE,   37, 37
	db 10, NIDORINO,    44, 44
	db 10, RHYHORN,     36, 36
	db 10, KANGASKHAN,  38, 38
	db  5, PINSIR,      36, 36
	db  5, HERACROSS,   36, 36
	db  4, CHANSEY,     36, 36
	db  1, SCYTHER,     35, 35
; day/eve  
	db 20, NIDORAN_F,   32, 32
...
; SafariKanto1
	table_width 4
; morning
	db 20, NIDORAN_F,   35, 35
	db 20, NIDORAN_M,   35, 35
	db 15, EXEGGCUTE,   36, 36
	db 10, NIDORINA,    43, 43
	db 10, TAUROS,      36, 36
	db 10, GIRAFARIG,   38, 38
	db  5, DODUO,       36, 36
	db  5, SKARMORY,    36, 36
	db  4, PINSIR,      36, 36
	db  1, KANGASKHAN,  35, 35
; day/eve  
	db 20, NIDORAN_F,   35, 35
	db 20, NIDORAN_M,   35, 35
	db 15, EXEGGCUTE,   36, 36
