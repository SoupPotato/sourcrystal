...
.Tanner:
	farwritetext TannerWantsRematchText
	buttonsound
	end
...
.Torin:
	farwritetext TorinWantsRematchText
	buttonsound
	end

.Billy:
	farwritetext BillyWantsRematchText
	buttonsound
	end
...
.Reese:
	farwritetext ReeseWantsRematchText
	buttonsound
	end
...
.Hillary:
	farwritetext HillaryHangUpText
	end
