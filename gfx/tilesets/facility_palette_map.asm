	...
	tilepal 0, WATER, RED, WATER, WATER, ROOF, ROOF, ROOF, ROOF
	...
	tilepal 1, BROWN, GRAY, GRAY, BROWN, BROWN, BROWN, BROWN, BROWN
	tilepal 1, BROWN, BROWN, GREEN, WATER, WATER, RED, BROWN, BROWN
	tilepal 1, BROWN, BROWN, RED, BROWN, GREEN, RED, RED, BROWN
	tilepal 1, BROWN, BROWN, GREEN, GREEN, RED, RED, RED, BROWN
	tilepal 1, RED, RED, RED, RED, RED, GRAY, GRAY, BROWN
	tilepal 1, WATER, WATER, BROWN, RED, RED, RED, BROWN, WATER
	tilepal 1, BROWN, BROWN, GRAY, BROWN, BROWN, BROWN, BROWN, GRAY
	tilepal 1, WATER, WATER, BROWN, BROWN, BROWN, GRAY, BROWN, ROOF
