	...
	tilepal 1, GRAY, GRAY, GRAY, BROWN, GREEN, GRAY, GRAY, BROWN
	tilepal 1, BROWN, BROWN, BROWN, BROWN, BROWN, BROWN, RED, BROWN
	tilepal 1, GRAY, GRAY, RED, RED, RED, GRAY, GRAY, BROWN
	tilepal 1, GRAY, WATER, BROWN, RED, RED, RED, BROWN, WATER
	tilepal 1, BROWN, BROWN, GRAY, GRAY, GRAY, GRAY, BROWN, GRAY
	tilepal 1, GRAY, GRAY, BROWN, BROWN, BROWN, GRAY, BROWN, ROOF
