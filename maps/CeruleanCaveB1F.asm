...
CeruleanCaveB1FMewtwo:
	...
	pause 15
	closetext
	writecode VAR_BATTLETYPE, BATTLETYPE_MEWTWO
...
CeruleanCaveB1F_MapEvents:
	...
	object_event 34, 17, SPRITE_JYNX, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0,  CeruleanCaveB1FMewtwo, EVENT_MEWTWO_APPEAR
