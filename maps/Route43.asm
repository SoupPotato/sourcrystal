...
.HasSilkScarf:
	...
	iffalse .NoRoom
	clearflag ENGINE_TIFFANY_HAS_POKE_DOLL
	setevent ENGINE_TIFFANY_GAVE_POKE_DOLL
	sjump .NumberAccepted
...
Route43_MapEvents:
	...
	object_event  1, 26, SPRITE_APRICORN, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, PAL_NPC_BLACK, OBJECTTYPE_SCRIPT, 0, Route43ApricornTree, EVENT_ROUTE_43_APRICORN
