...
SafariZoneKantoEntranceMainOfficerScript:
	...
	waitsfx
	warpfacing UP, SAFARI_ZONE_KANTO_AREA_1, 14, 25
	setevent EVENT_SAFARI_ZONE_KANTO_ENTRANCE_OFFICER_SAFARI_GAME_NOT_ACTIVE
	clearevent EVENT_SAFARI_ZONE_KANTO_ENTRANCE_OFFICER_SAFARI_GAME_ACTIVE
	end
...
SafariZoneKantoEntrance_MapEvents:
	...
	object_event  3,  2, SPRITE_OFFICER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_GREEN, PERSONTYPE_SCRIPT, 0, SafariZoneKantoEntranceMainOfficerScript, EVENT_SAFARI_ZONE_KANTO_ENTRANCE_OFFICER_SAFARI_GAME_NOT_ACTIVE
	object_event  2,  1, SPRITE_OFFICER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_GREEN, PERSONTYPE_SCRIPT, 0, SafariZoneKantoEntranceMainOfficerScript, EVENT_SAFARI_ZONE_KANTO_ENTRANCE_OFFICER_SAFARI_GAME_ACTIVE
