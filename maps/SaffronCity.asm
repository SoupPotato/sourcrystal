...
SaffronCity_MapEvents:
	...
	def_warp_events
	warp_event 26,  5, FIGHTING_DOJO, 1
	warp_event 34,  5, SAFFRON_GYM, 1
	warp_event 25, 13, SAFFRON_MART, 2
	warp_event  9, 31, SAFFRON_POKECENTER_1F, 1
	warp_event 29, 31, MR_PSYCHICS_HOUSE, 1
	warp_event  8,  5, SAFFRON_MAGNET_TRAIN_STATION, 2
	warp_event 18, 23, SILPH_CO_1F, 1
	warp_event  9, 13, COPYCATS_HOUSE_1F, 1
	warp_event 18,  3, ROUTE_5_SAFFRON_GATE, 3
	warp_event  0, 24, ROUTE_7_SAFFRON_GATE, 3
	warp_event  0, 25, ROUTE_7_SAFFRON_GATE, 4
	warp_event 16, 39, ROUTE_6_SAFFRON_GATE, 1
	warp_event 17, 39, ROUTE_6_SAFFRON_GATE, 2
	warp_event 39, 24, ROUTE_8_SAFFRON_GATE, 1
	warp_event 39, 25, ROUTE_8_SAFFRON_GATE, 2

	def_coord_events

	def_bg_events
	bg_event 21,  7, BGEVENT_READ, SaffronCitySign
	bg_event 33,  7, BGEVENT_READ, SaffronGymSign
	bg_event 25,  7, BGEVENT_READ, FightingDojoSign
	bg_event 15, 23, BGEVENT_READ, SilphCoSign
	bg_event 27, 31, BGEVENT_READ, MrPsychicsHouseSign
	bg_event 11,  7, BGEVENT_READ, SaffronCityMagnetTrainStationSign
	bg_event 10, 31, BGEVENT_READ, SaffronCityPokecenterSign
	bg_event 26, 13, BGEVENT_READ, SaffronCityMartSign

	def_object_events
	object_event  7, 16, SPRITE_LASS, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 2, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, SaffronCityLass1Script, -1
	object_event 19, 32, SPRITE_POKEFAN_M, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 2, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, SaffronCityPokefanMScript, -1
	object_event 32,  9, SPRITE_COOLTRAINER_M, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 1, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, SaffronCityCooltrainerMScript, -1
	object_event 20, 26, SPRITE_COOLTRAINER_F, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 2, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, SaffronCityCooltrainerFScript, -1
	object_event 27, 14, SPRITE_FISHER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, SaffronCityFisherScript, -1
	object_event 15, 21, SPRITE_YOUNGSTER, SPRITEMOVEDATA_WALK_UP_DOWN, 0, 1, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, SaffronCityYoungster1Script, -1
	...
	object_event 19, 10, SPRITE_LASS, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, SaffronCityLass2Script, -1
