...
UnionCave1F_MapEvents:
	...
	object_event  4, 17, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, UnionCave1FOpalShard, EVENT_UNION_CAVE_1F_OPAL_SHARD
